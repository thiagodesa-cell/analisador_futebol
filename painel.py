...
st.set_page_config(page_title="Painel Proimport streamlit as st
import pandas as pd
import requests
from datetime import datetime, timedelta
...
if st.sidebar.button("🚀 Disparar Alerta Pré-Live"):
    if TELEGRAM_CHAT_ID == "DIGITE_SEU_ID_AQUI":
        st.sidebar.warning("⚠️ Insira o seu ID do Telegram na linha 14 do código antes de enviar!")
    else:
        # Monta a mensagem estruturada com os dados calculados na tela
...
📈 <i>Dica: Abra o Painel Streamlit para conferir o scout minucioso de desarmes e finalizações do plantel completo!</i>"""
